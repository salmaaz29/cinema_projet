...
{// name c est identifiant unique  de chaque route ne pas avoir meme nom de 2 routes
    #[Route('/controller', name: 'app_pre_controller')]   // associe l url a la fct qui va etre executer --si j'envoie une requette /first je peut repondre par cette fct 
    ...
    public function affiche(Utilisateur $user): Response
    {
